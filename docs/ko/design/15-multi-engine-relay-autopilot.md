...
상태: experimental recorder/checker 첫 slice 구현 완료. Active relay execution과
external engine adapter는 계속 deferred 0.2/0.3 설계 작업입니다.
...
8. Deferred: 그 다음에만 external relay adapter를 검토합니다.
