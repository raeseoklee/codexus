...
| Compiled wiki | `codexus wiki map/build/check/export`, `codexus wiki context --approve` | Regenerable markdown projection and visible non-injected context approval artifacts. |
