...
- [Worktree app instance launcher](design/19-worktree-app-instance-launcher.md): experimental live ownership app instance surface for per-worktree app evidence; live start/stop works for Codexus-owned instances and stays outside the stable 0.1.x contract.
