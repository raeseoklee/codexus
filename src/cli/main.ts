...
Usage:
  ...
  cx schema validate --type <config|state|event|memory-entry|skill|session-state|supply-chain-policy|architecture-policy|autopilot-contract|wiki-manifest|wiki-advisory|repo-graph|relay-session|stage-gate-evidence|convergence-agreement|decision|session-tasks|app-instance-descriptor|app-instance|app-instance-observation|automation-dispatch|automation-recovery|subagent-result|subagent-launch-contract|app-server-discovery|app-server-stage-a|app-server-stage-b|app-server-stdio-proof> --file <path> [--json]
